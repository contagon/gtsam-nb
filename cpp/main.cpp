...
PYBIND11_MODULE(gtsam, m_) {
  ...
  py::class_<gtsam::KeyList, boost::shared_ptr<gtsam::KeyList>>(m_, "KeyList")
      ...
      .def(py::pickle([](const gtsam::KeyList &a) { /* __getstate__: Returns a string that encodes the state of the object */ return py::make_tuple(gtsam::serialize(a)); }, [](py::tuple t) { /* __setstate__ */ gtsam::KeyList obj; gtsam::deserialize(t[0].cast<std::string>(), obj); return obj; }));
  ...
  py::class_<gtsam::KeySet, boost::shared_ptr<gtsam::KeySet>>(m_, "KeySet")
      ...
      .def(py::pickle([](const gtsam::KeySet &a) { /* __getstate__: Returns a string that encodes the state of the object */ return py::make_tuple(gtsam::serialize(a)); }, [](py::tuple t) { /* __setstate__ */ gtsam::KeySet obj; gtsam::deserialize(t[0].cast<std::string>(), obj); return obj; }));

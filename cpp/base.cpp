...
void base(py::module_ &m_) {
  ...
  py::class_<gtsam::GenericValue<gtsam::Vector>, gtsam::Value, boost::shared_ptr<gtsam::GenericValue<gtsam::Vector>>>(m_, "GenericValueVector")
      ...
      .def(py::pickle([](const gtsam::GenericValue<gtsam::Vector> &a) { /* __getstate__: Returns a string that encodes the state of the object */ return py::make_tuple(gtsam::serialize(a)); }, [](py::tuple t) { /* __setstate__ */ gtsam::GenericValue<gtsam::Vector> obj; gtsam::deserialize(t[0].cast<std::string>(), obj); return obj; }));
  ...
  py::class_<gtsam::GenericValue<gtsam::Matrix>, gtsam::Value, boost::shared_ptr<gtsam::GenericValue<gtsam::Matrix>>>(m_, "GenericValueMatrix")
      ...
      .def(py::pickle([](const gtsam::GenericValue<gtsam::Matrix> &a) { /* __getstate__: Returns a string that encodes the state of the object */ return py::make_tuple(gtsam::serialize(a)); }, [](py::tuple t) { /* __setstate__ */ gtsam::GenericValue<gtsam::Matrix> obj; gtsam::deserialize(t[0].cast<std::string>(), obj); return obj; }));
  ...
  py::class_<gtsam::GenericValue<gtsam::Point2>, gtsam::Value, boost::shared_ptr<gtsam::GenericValue<gtsam::Point2>>>(m_, "GenericValuePoint2")
      ...
      .def(py::pickle([](const gtsam::GenericValue<gtsam::Point2> &a) { /* __getstate__: Returns a string that encodes the state of the object */ return py::make_tuple(gtsam::serialize(a)); }, [](py::tuple t) { /* __setstate__ */ gtsam::GenericValue<gtsam::Point2> obj; gtsam::deserialize(t[0].cast<std::string>(), obj); return obj; }));
  ...
  py::class_<gtsam::GenericValue<gtsam::Point3>, gtsam::Value, boost::shared_ptr<gtsam::GenericValue<gtsam::Point3>>>(m_, "GenericValuePoint3")
      ...
      .def(py::pickle([](const gtsam::GenericValue<gtsam::Point3> &a) { /* __getstate__: Returns a string that encodes the state of the object */ return py::make_tuple(gtsam::serialize(a)); }, [](py::tuple t) { /* __setstate__ */ gtsam::GenericValue<gtsam::Point3> obj; gtsam::deserialize(t[0].cast<std::string>(), obj); return obj; }));
  ...
  py::class_<gtsam::GenericValue<gtsam::Rot2>, gtsam::Value, boost::shared_ptr<gtsam::GenericValue<gtsam::Rot2>>>(m_, "GenericValueRot2")
      ...
      .def(py::pickle([](const gtsam::GenericValue<gtsam::Rot2> &a) { /* __getstate__: Returns a string that encodes the state of the object */ return py::make_tuple(gtsam::serialize(a)); }, [](py::tuple t) { /* __setstate__ */ gtsam::GenericValue<gtsam::Rot2> obj; gtsam::deserialize(t[0].cast<std::string>(), obj); return obj; }));
  ...
  py::class_<gtsam::GenericValue<gtsam::Rot3>, gtsam::Value, boost::shared_ptr<gtsam::GenericValue<gtsam::Rot3>>>(m_, "GenericValueRot3")
      ...
      .def(py::pickle([](const gtsam::GenericValue<gtsam::Rot3> &a) { /* __getstate__: Returns a string that encodes the state of the object */ return py::make_tuple(gtsam::serialize(a)); }, [](py::tuple t) { /* __setstate__ */ gtsam::GenericValue<gtsam::Rot3> obj; gtsam::deserialize(t[0].cast<std::string>(), obj); return obj; }));
  ...
  py::class_<gtsam::GenericValue<gtsam::Pose2>, gtsam::Value, boost::shared_ptr<gtsam::GenericValue<gtsam::Pose2>>>(m_, "GenericValuePose2")
      ...
      .def(py::pickle([](const gtsam::GenericValue<gtsam::Pose2> &a) { /* __getstate__: Returns a string that encodes the state of the object */ return py::make_tuple(gtsam::serialize(a)); }, [](py::tuple t) { /* __setstate__ */ gtsam::GenericValue<gtsam::Pose2> obj; gtsam::deserialize(t[0].cast<std::string>(), obj); return obj; }));
  ...
  py::class_<gtsam::GenericValue<gtsam::Pose3>, gtsam::Value, boost::shared_ptr<gtsam::GenericValue<gtsam::Pose3>>>(m_, "GenericValuePose3")
      ...
      .def(py::pickle([](const gtsam::GenericValue<gtsam::Pose3> &a) { /* __getstate__: Returns a string that encodes the state of the object */ return py::make_tuple(gtsam::serialize(a)); }, [](py::tuple t) { /* __setstate__ */ gtsam::GenericValue<gtsam::Pose3> obj; gtsam::deserialize(t[0].cast<std::string>(), obj); return obj; }));
  ...
  py::class_<gtsam::GenericValue<gtsam::StereoPoint2>, gtsam::Value, boost::shared_ptr<gtsam::GenericValue<gtsam::StereoPoint2>>>(m_, "GenericValueStereoPoint2")
      ...
      .def(py::pickle([](const gtsam::GenericValue<gtsam::StereoPoint2> &a) { /* __getstate__: Returns a string that encodes the state of the object */ return py::make_tuple(gtsam::serialize(a)); }, [](py::tuple t) { /* __setstate__ */ gtsam::GenericValue<gtsam::StereoPoint2> obj; gtsam::deserialize(t[0].cast<std::string>(), obj); return obj; }));
  ...
  py::class_<gtsam::GenericValue<gtsam::Cal3_S2>, gtsam::Value, boost::shared_ptr<gtsam::GenericValue<gtsam::Cal3_S2>>>(m_, "GenericValueCal3_S2")
      ...
      .def(py::pickle([](const gtsam::GenericValue<gtsam::Cal3_S2> &a) { /* __getstate__: Returns a string that encodes the state of the object */ return py::make_tuple(gtsam::serialize(a)); }, [](py::tuple t) { /* __setstate__ */ gtsam::GenericValue<gtsam::Cal3_S2> obj; gtsam::deserialize(t[0].cast<std::string>(), obj); return obj; }));
  ...
  py::class_<gtsam::GenericValue<gtsam::Cal3DS2>, gtsam::Value, boost::shared_ptr<gtsam::GenericValue<gtsam::Cal3DS2>>>(m_, "GenericValueCal3DS2")
      ...
      .def(py::pickle([](const gtsam::GenericValue<gtsam::Cal3DS2> &a) { /* __getstate__: Returns a string that encodes the state of the object */ return py::make_tuple(gtsam::serialize(a)); }, [](py::tuple t) { /* __setstate__ */ gtsam::GenericValue<gtsam::Cal3DS2> obj; gtsam::deserialize(t[0].cast<std::string>(), obj); return obj; }));
  ...
  py::class_<gtsam::GenericValue<gtsam::Cal3Bundler>, gtsam::Value, boost::shared_ptr<gtsam::GenericValue<gtsam::Cal3Bundler>>>(m_, "GenericValueCal3Bundler")
      ...
      .def(py::pickle([](const gtsam::GenericValue<gtsam::Cal3Bundler> &a) { /* __getstate__: Returns a string that encodes the state of the object */ return py::make_tuple(gtsam::serialize(a)); }, [](py::tuple t) { /* __setstate__ */ gtsam::GenericValue<gtsam::Cal3Bundler> obj; gtsam::deserialize(t[0].cast<std::string>(), obj); return obj; }));
  ...
  py::class_<gtsam::GenericValue<gtsam::Cal3Fisheye>, gtsam::Value, boost::shared_ptr<gtsam::GenericValue<gtsam::Cal3Fisheye>>>(m_, "GenericValueCal3Fisheye")
      ...
      .def(py::pickle([](const gtsam::GenericValue<gtsam::Cal3Fisheye> &a) { /* __getstate__: Returns a string that encodes the state of the object */ return py::make_tuple(gtsam::serialize(a)); }, [](py::tuple t) { /* __setstate__ */ gtsam::GenericValue<gtsam::Cal3Fisheye> obj; gtsam::deserialize(t[0].cast<std::string>(), obj); return obj; }));
  ...
  py::class_<gtsam::GenericValue<gtsam::Cal3Unified>, gtsam::Value, boost::shared_ptr<gtsam::GenericValue<gtsam::Cal3Unified>>>(m_, "GenericValueCal3Unified")
      ...
      .def(py::pickle([](const gtsam::GenericValue<gtsam::Cal3Unified> &a) { /* __getstate__: Returns a string that encodes the state of the object */ return py::make_tuple(gtsam::serialize(a)); }, [](py::tuple t) { /* __setstate__ */ gtsam::GenericValue<gtsam::Cal3Unified> obj; gtsam::deserialize(t[0].cast<std::string>(), obj); return obj; }));
  ...
  py::class_<gtsam::GenericValue<gtsam::EssentialMatrix>, gtsam::Value, boost::shared_ptr<gtsam::GenericValue<gtsam::EssentialMatrix>>>(m_, "GenericValueEssentialMatrix")
      ...
      .def(py::pickle([](const gtsam::GenericValue<gtsam::EssentialMatrix> &a) { /* __getstate__: Returns a string that encodes the state of the object */ return py::make_tuple(gtsam::serialize(a)); }, [](py::tuple t) { /* __setstate__ */ gtsam::GenericValue<gtsam::EssentialMatrix> obj; gtsam::deserialize(t[0].cast<std::string>(), obj); return obj; }));
  ...
  py::class_<gtsam::GenericValue<gtsam::CalibratedCamera>, gtsam::Value, boost::shared_ptr<gtsam::GenericValue<gtsam::CalibratedCamera>>>(m_, "GenericValueCalibratedCamera")
      ...
      .def(py::pickle([](const gtsam::GenericValue<gtsam::CalibratedCamera> &a) { /* __getstate__: Returns a string that encodes the state of the object */ return py::make_tuple(gtsam::serialize(a)); }, [](py::tuple t) { /* __setstate__ */ gtsam::GenericValue<gtsam::CalibratedCamera> obj; gtsam::deserialize(t[0].cast<std::string>(), obj); return obj; }));
  ...
  py::class_<gtsam::GenericValue<gtsam::imuBias::ConstantBias>, gtsam::Value, boost::shared_ptr<gtsam::GenericValue<gtsam::imuBias::ConstantBias>>>(m_, "GenericValueConstantBias")
      ...
      .def(py::pickle([](const gtsam::GenericValue<gtsam::imuBias::ConstantBias> &a) { /* __getstate__: Returns a string that encodes the state of the object */ return py::make_tuple(gtsam::serialize(a)); }, [](py::tuple t) { /* __setstate__ */ gtsam::GenericValue<gtsam::imuBias::ConstantBias> obj; gtsam::deserialize(t[0].cast<std::string>(), obj); return obj; }));

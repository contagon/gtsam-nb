...
void base(nb::module_ &m_) {
  ...
  nb::class_<gtsam::GenericValue<gtsam::Vector>, gtsam::Value>(m_, "GenericValueVector")
      .def("value", [](gtsam::GenericValue<gtsam::Vector> *self) { return self->value(); });
  ...
  nb::class_<gtsam::GenericValue<gtsam::Matrix>, gtsam::Value>(m_, "GenericValueMatrix")
      .def("value", [](gtsam::GenericValue<gtsam::Matrix> *self) { return self->value(); });
  ...
  nb::class_<gtsam::GenericValue<gtsam::Point2>, gtsam::Value>(m_, "GenericValuePoint2")
      .def("value", [](gtsam::GenericValue<gtsam::Point2> *self) { return self->value(); });
  ...
  nb::class_<gtsam::GenericValue<gtsam::Point3>, gtsam::Value>(m_, "GenericValuePoint3")
      .def("value", [](gtsam::GenericValue<gtsam::Point3> *self) { return self->value(); });
  ...
  // .def(nb::pickle([](const gtsam::GenericValue<gtsam::Unit3> &a) { /* __getstate__: Returns a string that encodes the state of the object */ return nb::make_tuple(gtsam::serialize(a)); }, [](nb::tuple t) { /* __setstate__ */ gtsam::GenericValue<gtsam::Point3> obj; gtsam::deserialize(t[0].cast<std::string>(), obj); return obj; }));

  nb::class_<gtsam::GenericValue<gtsam::Rot2>, gtsam::Value>(m_, "GenericValueRot2")
      .def("value", [](gtsam::GenericValue<gtsam::Rot2> *self) { return self->value(); });
  ...
  nb::class_<gtsam::GenericValue<gtsam::Rot3>, gtsam::Value>(m_, "GenericValueRot3")
      .def("value", [](gtsam::GenericValue<gtsam::Rot3> *self) { return self->value(); });
  ...
  nb::class_<gtsam::GenericValue<gtsam::Pose2>, gtsam::Value>(m_, "GenericValuePose2")
      .def("value", [](gtsam::GenericValue<gtsam::Pose2> *self) { return self->value(); });
  ...
  nb::class_<gtsam::GenericValue<gtsam::Pose3>, gtsam::Value>(m_, "GenericValuePose3")
      .def("value", [](gtsam::GenericValue<gtsam::Pose3> *self) { return self->value(); });
  ...
  nb::class_<gtsam::GenericValue<gtsam::Cal3_S2>, gtsam::Value>(m_, "GenericValueCal3_S2")
      .def("value", [](gtsam::GenericValue<gtsam::Cal3_S2> *self) { return self->value(); });
  ...
  nb::class_<gtsam::GenericValue<gtsam::Cal3DS2>, gtsam::Value>(m_, "GenericValueCal3DS2")
      .def("value", [](gtsam::GenericValue<gtsam::Cal3DS2> *self) { return self->value(); });
  ...
  nb::class_<gtsam::GenericValue<gtsam::Cal3Bundler>, gtsam::Value>(m_, "GenericValueCal3Bundler")
      .def("value", [](gtsam::GenericValue<gtsam::Cal3Bundler> *self) { return self->value(); });
  ...
  nb::class_<gtsam::GenericValue<gtsam::Cal3Fisheye>, gtsam::Value>(m_, "GenericValueCal3Fisheye")
      .def("value", [](gtsam::GenericValue<gtsam::Cal3Fisheye> *self) { return self->value(); });
  ...
  nb::class_<gtsam::GenericValue<gtsam::Cal3Unified>, gtsam::Value>(m_, "GenericValueCal3Unified")
      .def("value", [](gtsam::GenericValue<gtsam::Cal3Unified> *self) { return self->value(); });
  ...
  nb::class_<gtsam::GenericValue<gtsam::EssentialMatrix>, gtsam::Value>(m_, "GenericValueEssentialMatrix")
      .def("value", [](gtsam::GenericValue<gtsam::EssentialMatrix> *self) { return self->value(); });
  ...
  nb::class_<gtsam::GenericValue<gtsam::CalibratedCamera>, gtsam::Value>(m_, "GenericValueCalibratedCamera")
      .def("value", [](gtsam::GenericValue<gtsam::CalibratedCamera> *self) { return self->value(); });
  ...
  nb::class_<gtsam::GenericValue<gtsam::imuBias::ConstantBias>, gtsam::Value>(m_, "GenericValueConstantBias")
      .def("value", [](gtsam::GenericValue<gtsam::imuBias::ConstantBias> *self) { return self->value(); });

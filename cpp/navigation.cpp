...
void navigation(py::module_ &m_) {
  ...
  py::class_<gtsam::imuBias::ConstantBias, boost::shared_ptr<gtsam::imuBias::ConstantBias>>(m_imuBias, "ConstantBias")
      ...
      .def(py::pickle([](const gtsam::imuBias::ConstantBias &a) { /* __getstate__: Returns a string that encodes the state of the object */ return py::make_tuple(gtsam::serialize(a)); }, [](py::tuple t) { /* __setstate__ */ gtsam::imuBias::ConstantBias obj; gtsam::deserialize(t[0].cast<std::string>(), obj); return obj; }))
  ...
  py::class_<gtsam::NavState, boost::shared_ptr<gtsam::NavState>>(m_, "NavState")
      ...
      .def(py::pickle([](const gtsam::NavState &a) { /* __getstate__: Returns a string that encodes the state of the object */ return py::make_tuple(gtsam::serialize(a)); }, [](py::tuple t) { /* __setstate__ */ gtsam::NavState obj; gtsam::deserialize(t[0].cast<std::string>(), obj); return obj; }));
  ...
  py::class_<gtsam::PreintegrationParams, gtsam::PreintegratedRotationParams, boost::shared_ptr<gtsam::PreintegrationParams>>(m_, "PreintegrationParams")
      ...
      .def(py::pickle([](const gtsam::PreintegrationParams &a) { /* __getstate__: Returns a string that encodes the state of the object */ return py::make_tuple(gtsam::serialize(a)); }, [](py::tuple t) { /* __setstate__ */ gtsam::PreintegrationParams obj; gtsam::deserialize(t[0].cast<std::string>(), obj); return obj; }))
  ...
  py::class_<gtsam::PreintegratedImuMeasurements, boost::shared_ptr<gtsam::PreintegratedImuMeasurements>>(m_, "PreintegratedImuMeasurements")
      ...
      .def(py::pickle([](const gtsam::PreintegratedImuMeasurements &a) { /* __getstate__: Returns a string that encodes the state of the object */ return py::make_tuple(gtsam::serialize(a)); }, [](py::tuple t) { /* __setstate__ */ gtsam::PreintegratedImuMeasurements obj; gtsam::deserialize(t[0].cast<std::string>(), obj); return obj; }));
  ...
  py::class_<gtsam::PreintegratedCombinedMeasurements, boost::shared_ptr<gtsam::PreintegratedCombinedMeasurements>>(m_, "PreintegratedCombinedMeasurements")
      ...
      .def("__repr__", [](const gtsam::PreintegratedCombinedMeasurements &self, string s) {
                        gtsam::RedirectCout redirect;
                        self.print(s);
                        return redirect.str(); }, py::arg("s") = "Preintegrated Measurements:")
  ...
  py::class_<gtsam::PreintegratedAhrsMeasurements, boost::shared_ptr<gtsam::PreintegratedAhrsMeasurements>>(m_, "PreintegratedAhrsMeasurements")
      .def(py::init<const boost::shared_ptr<gtsam::PreintegrationParams>, const gtsam::Vector &>(), py::arg("params"), py::arg("biasHat"))
      .def(py::init<const boost::shared_ptr<gtsam::PreintegrationParams>, const gtsam::Vector &, double, const gtsam::Rot3 &, const gtsam::Matrix &, const gtsam::Matrix &>(), py::arg("p"), py::arg("bias_hat"), py::arg("deltaTij"), py::arg("deltaRij"), py::arg("delRdelBiasOmega"), py::arg("preint_meas_cov"))

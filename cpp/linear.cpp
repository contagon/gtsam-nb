...
void linear(py::module_ &m_) {
  ...
  py::class_<gtsam::noiseModel::Gaussian, gtsam::noiseModel::Base, boost::shared_ptr<gtsam::noiseModel::Gaussian>>(m_noiseModel, "Gaussian")
      ...
      .def(py::pickle([](const gtsam::noiseModel::Gaussian &a) { /* __getstate__: Returns a string that encodes the state of the object */ return py::make_tuple(gtsam::serialize(a)); }, [](py::tuple t) { /* __setstate__ */ gtsam::noiseModel::Gaussian obj; gtsam::deserialize(t[0].cast<std::string>(), obj); return obj; }))
  ...
  py::class_<gtsam::noiseModel::Diagonal, gtsam::noiseModel::Gaussian, boost::shared_ptr<gtsam::noiseModel::Diagonal>>(m_noiseModel, "Diagonal")
      ...
      .def(py::pickle([](const gtsam::noiseModel::Diagonal &a) { /* __getstate__: Returns a string that encodes the state of the object */ return py::make_tuple(gtsam::serialize(a)); }, [](py::tuple t) { /* __setstate__ */ gtsam::noiseModel::Diagonal obj; gtsam::deserialize(t[0].cast<std::string>(), obj); return obj; }))
  ...
  py::class_<gtsam::noiseModel::Constrained, gtsam::noiseModel::Diagonal, boost::shared_ptr<gtsam::noiseModel::Constrained>>(m_noiseModel, "Constrained")
      ...
      .def(py::pickle([](const gtsam::noiseModel::Constrained &a) { /* __getstate__: Returns a string that encodes the state of the object */ return py::make_tuple(gtsam::serialize(a)); }, [](py::tuple t) { /* __setstate__ */ gtsam::noiseModel::Constrained obj; gtsam::deserialize(t[0].cast<std::string>(), obj); return obj; }))
  ...
  py::class_<gtsam::noiseModel::Isotropic, gtsam::noiseModel::Diagonal, boost::shared_ptr<gtsam::noiseModel::Isotropic>>(m_noiseModel, "Isotropic")
      ...
      .def(py::pickle([](const gtsam::noiseModel::Isotropic &a) { /* __getstate__: Returns a string that encodes the state of the object */ return py::make_tuple(gtsam::serialize(a)); }, [](py::tuple t) { /* __setstate__ */ gtsam::noiseModel::Isotropic obj; gtsam::deserialize(t[0].cast<std::string>(), obj); return obj; }))
  ...
  py::class_<gtsam::noiseModel::Unit, gtsam::noiseModel::Isotropic, boost::shared_ptr<gtsam::noiseModel::Unit>>(m_noiseModel, "Unit")
      ...
      .def(py::pickle([](const gtsam::noiseModel::Unit &a) { /* __getstate__: Returns a string that encodes the state of the object */ return py::make_tuple(gtsam::serialize(a)); }, [](py::tuple t) { /* __setstate__ */ gtsam::noiseModel::Unit obj; gtsam::deserialize(t[0].cast<std::string>(), obj); return obj; }))
  ...
  py::class_<gtsam::noiseModel::mEstimator::Null, gtsam::noiseModel::mEstimator::Base, boost::shared_ptr<gtsam::noiseModel::mEstimator::Null>>(m_noiseModel_mEstimator, "Null")
      ...
      .def(py::pickle([](const gtsam::noiseModel::mEstimator::Null &a) { /* __getstate__: Returns a string that encodes the state of the object */ return py::make_tuple(gtsam::serialize(a)); }, [](py::tuple t) { /* __setstate__ */ gtsam::noiseModel::mEstimator::Null obj; gtsam::deserialize(t[0].cast<std::string>(), obj); return obj; }))
  ...
  py::class_<gtsam::noiseModel::mEstimator::Fair, gtsam::noiseModel::mEstimator::Base, boost::shared_ptr<gtsam::noiseModel::mEstimator::Fair>>(m_noiseModel_mEstimator, "Fair")
      ...
      .def(py::pickle([](const gtsam::noiseModel::mEstimator::Fair &a) { /* __getstate__: Returns a string that encodes the state of the object */ return py::make_tuple(gtsam::serialize(a)); }, [](py::tuple t) { /* __setstate__ */ gtsam::noiseModel::mEstimator::Fair obj; gtsam::deserialize(t[0].cast<std::string>(), obj); return obj; }))
  ...
  py::class_<gtsam::noiseModel::mEstimator::Huber, gtsam::noiseModel::mEstimator::Base, boost::shared_ptr<gtsam::noiseModel::mEstimator::Huber>>(m_noiseModel_mEstimator, "Huber")
      ...
      .def(py::pickle([](const gtsam::noiseModel::mEstimator::Huber &a) { /* __getstate__: Returns a string that encodes the state of the object */ return py::make_tuple(gtsam::serialize(a)); }, [](py::tuple t) { /* __setstate__ */ gtsam::noiseModel::mEstimator::Huber obj; gtsam::deserialize(t[0].cast<std::string>(), obj); return obj; }))
  ...
  py::class_<gtsam::noiseModel::mEstimator::Cauchy, gtsam::noiseModel::mEstimator::Base, boost::shared_ptr<gtsam::noiseModel::mEstimator::Cauchy>>(m_noiseModel_mEstimator, "Cauchy")
      ...
      .def(py::pickle([](const gtsam::noiseModel::mEstimator::Cauchy &a) { /* __getstate__: Returns a string that encodes the state of the object */ return py::make_tuple(gtsam::serialize(a)); }, [](py::tuple t) { /* __setstate__ */ gtsam::noiseModel::mEstimator::Cauchy obj; gtsam::deserialize(t[0].cast<std::string>(), obj); return obj; }))
  ...
  py::class_<gtsam::noiseModel::mEstimator::Tukey, gtsam::noiseModel::mEstimator::Base, boost::shared_ptr<gtsam::noiseModel::mEstimator::Tukey>>(m_noiseModel_mEstimator, "Tukey")
      ...
      .def(py::pickle([](const gtsam::noiseModel::mEstimator::Tukey &a) { /* __getstate__: Returns a string that encodes the state of the object */ return py::make_tuple(gtsam::serialize(a)); }, [](py::tuple t) { /* __setstate__ */ gtsam::noiseModel::mEstimator::Tukey obj; gtsam::deserialize(t[0].cast<std::string>(), obj); return obj; }))
  ...
  py::class_<gtsam::noiseModel::mEstimator::Welsch, gtsam::noiseModel::mEstimator::Base, boost::shared_ptr<gtsam::noiseModel::mEstimator::Welsch>>(m_noiseModel_mEstimator, "Welsch")
      ...
      .def(py::pickle([](const gtsam::noiseModel::mEstimator::Welsch &a) { /* __getstate__: Returns a string that encodes the state of the object */ return py::make_tuple(gtsam::serialize(a)); }, [](py::tuple t) { /* __setstate__ */ gtsam::noiseModel::mEstimator::Welsch obj; gtsam::deserialize(t[0].cast<std::string>(), obj); return obj; }))
  ...
  py::class_<gtsam::noiseModel::mEstimator::GemanMcClure, gtsam::noiseModel::mEstimator::Base, boost::shared_ptr<gtsam::noiseModel::mEstimator::GemanMcClure>>(m_noiseModel_mEstimator, "GemanMcClure")
      ...
      .def(py::pickle([](const gtsam::noiseModel::mEstimator::GemanMcClure &a) { /* __getstate__: Returns a string that encodes the state of the object */ return py::make_tuple(gtsam::serialize(a)); }, [](py::tuple t) { /* __setstate__ */ gtsam::noiseModel::mEstimator::GemanMcClure obj; gtsam::deserialize(t[0].cast<std::string>(), obj); return obj; }))
  ...
  py::class_<gtsam::noiseModel::mEstimator::DCS, gtsam::noiseModel::mEstimator::Base, boost::shared_ptr<gtsam::noiseModel::mEstimator::DCS>>(m_noiseModel_mEstimator, "DCS")
      ...
      .def(py::pickle([](const gtsam::noiseModel::mEstimator::DCS &a) { /* __getstate__: Returns a string that encodes the state of the object */ return py::make_tuple(gtsam::serialize(a)); }, [](py::tuple t) { /* __setstate__ */ gtsam::noiseModel::mEstimator::DCS obj; gtsam::deserialize(t[0].cast<std::string>(), obj); return obj; }))
  ...
  py::class_<gtsam::noiseModel::mEstimator::L2WithDeadZone, gtsam::noiseModel::mEstimator::Base, boost::shared_ptr<gtsam::noiseModel::mEstimator::L2WithDeadZone>>(m_noiseModel_mEstimator, "L2WithDeadZone")
      ...
      .def(py::pickle([](const gtsam::noiseModel::mEstimator::L2WithDeadZone &a) { /* __getstate__: Returns a string that encodes the state of the object */ return py::make_tuple(gtsam::serialize(a)); }, [](py::tuple t) { /* __setstate__ */ gtsam::noiseModel::mEstimator::L2WithDeadZone obj; gtsam::deserialize(t[0].cast<std::string>(), obj); return obj; }))
  ...
  py::class_<gtsam::noiseModel::Robust, gtsam::noiseModel::Base, boost::shared_ptr<gtsam::noiseModel::Robust>>(m_noiseModel, "Robust")
      ...
      .def(py::pickle([](const gtsam::noiseModel::Robust &a) { /* __getstate__: Returns a string that encodes the state of the object */ return py::make_tuple(gtsam::serialize(a)); }, [](py::tuple t) { /* __setstate__ */ gtsam::noiseModel::Robust obj; gtsam::deserialize(t[0].cast<std::string>(), obj); return obj; }))
  ...
  py::class_<gtsam::VectorValues, boost::shared_ptr<gtsam::VectorValues>>(m_, "VectorValues")
      ...
      .def("__repr__", [](const gtsam::VectorValues &self, string s, const gtsam::KeyFormatter &keyFormatter) {
                        ...
                        return redirect.str(); }, py::arg("s") = "VectorValues", py::arg("keyFormatter") = gtsam::DefaultKeyFormatter)
      ...
      .def("vector", [](gtsam::VectorValues *self, const gtsam::KeyVector &keys) { return self->vector(keys); }, py::arg("keys"))
      .def("at", [](gtsam::VectorValues *self, size_t j) { return self->at(j); }, py::arg("j"))
      .def("insert", [](gtsam::VectorValues *self, const gtsam::VectorValues &values) { self->insert(values); }, py::arg("values"))
      ...
      .def(py::pickle([](const gtsam::VectorValues &a) { /* __getstate__: Returns a string that encodes the state of the object */ return py::make_tuple(gtsam::serialize(a)); }, [](py::tuple t) { /* __setstate__ */ gtsam::VectorValues obj; gtsam::deserialize(t[0].cast<std::string>(), obj); return obj; }))
  ...
  py::class_<gtsam::GaussianFactor, gtsam::Factor, boost::shared_ptr<gtsam::GaussianFactor>>(m_, "GaussianFactor")
  ...
  py::class_<gtsam::JacobianFactor, gtsam::GaussianFactor, boost::shared_ptr<gtsam::JacobianFactor>>(m_, "JacobianFactor")
      ...
      .def(py::pickle([](const gtsam::JacobianFactor &a) { /* __getstate__: Returns a string that encodes the state of the object */ return py::make_tuple(gtsam::serialize(a)); }, [](py::tuple t) { /* __setstate__ */ gtsam::JacobianFactor obj; gtsam::deserialize(t[0].cast<std::string>(), obj); return obj; }));
  ...
  py::class_<gtsam::HessianFactor, gtsam::GaussianFactor, boost::shared_ptr<gtsam::HessianFactor>>(m_, "HessianFactor")
      ...
      .def(py::pickle([](const gtsam::HessianFactor &a) { /* __getstate__: Returns a string that encodes the state of the object */ return py::make_tuple(gtsam::serialize(a)); }, [](py::tuple t) { /* __setstate__ */ gtsam::HessianFactor obj; gtsam::deserialize(t[0].cast<std::string>(), obj); return obj; }));
  ...
  py::class_<gtsam::GaussianFactorGraph, boost::shared_ptr<gtsam::GaussianFactorGraph>>(m_, "GaussianFactorGraph")
      ...
      .def(py::pickle([](const gtsam::GaussianFactorGraph &a) { /* __getstate__: Returns a string that encodes the state of the object */ return py::make_tuple(gtsam::serialize(a)); }, [](py::tuple t) { /* __setstate__ */ gtsam::GaussianFactorGraph obj; gtsam::deserialize(t[0].cast<std::string>(), obj); return obj; }));
  ...
  py::class_<gtsam::GaussianConditional, gtsam::JacobianFactor, boost::shared_ptr<gtsam::GaussianConditional>>(m_, "GaussianConditional")
      ...
      .def("__repr__", [](const gtsam::GaussianConditional &self, string s, const gtsam::KeyFormatter &keyFormatter) {
                        gtsam::RedirectCout redirect;
                        self.print(s, keyFormatter);
                        return redirect.str(); }, py::arg("s") = "GaussianConditional", py::arg("keyFormatter") = gtsam::DefaultKeyFormatter)
      ...
      .def("logProbability", [](gtsam::GaussianConditional *self, const gtsam::VectorValues &x) { return self->logProbability(x); }, py::arg("x"))
      .def("evaluate", [](gtsam::GaussianConditional *self, const gtsam::VectorValues &x) { return self->evaluate(x); }, py::arg("x"))
      .def("error", [](gtsam::GaussianConditional *self, const gtsam::VectorValues &x) { return self->error(x); }, py::arg("x"))
      ...
      .def(py::pickle([](const gtsam::GaussianConditional &a) { /* __getstate__: Returns a string that encodes the state of the object */ return py::make_tuple(gtsam::serialize(a)); }, [](py::tuple t) { /* __setstate__ */ gtsam::GaussianConditional obj; gtsam::deserialize(t[0].cast<std::string>(), obj); return obj; }))
      .def("logProbability", [](gtsam::GaussianConditional *self, const gtsam::HybridValues &x) { return self->logProbability(x); }, py::arg("x"))
      .def("evaluate", [](gtsam::GaussianConditional *self, const gtsam::HybridValues &x) { return self->evaluate(x); }, py::arg("x"))
      .def("error", [](gtsam::GaussianConditional *self, const gtsam::HybridValues &x) { return self->error(x); }, py::arg("x"))
      .def_static("FromMeanAndStddev", [](gtsam::Key key, const gtsam::Vector &mu, double sigma) { return gtsam::GaussianConditional::FromMeanAndStddev(key, mu, sigma); }, py::arg("key"), py::arg("mu"), py::arg("sigma"))
  ...
  py::class_<gtsam::GaussianDensity, gtsam::GaussianConditional, boost::shared_ptr<gtsam::GaussianDensity>>(m_, "GaussianDensity")
      ...
      .def("__repr__", [](const gtsam::GaussianDensity &self, string s, const gtsam::KeyFormatter &keyFormatter) {
                        gtsam::RedirectCout redirect;
                        self.print(s, keyFormatter);
                        return redirect.str(); }, py::arg("s") = "GaussianDensity", py::arg("keyFormatter") = gtsam::DefaultKeyFormatter)
  ...
  py::class_<gtsam::GaussianBayesNet, boost::shared_ptr<gtsam::GaussianBayesNet>>(m_, "GaussianBayesNet")
      ...
      .def("logProbability", [](gtsam::GaussianBayesNet *self, const gtsam::VectorValues &x) { return self->logProbability(x); }, py::arg("x"))
      .def("evaluate", [](gtsam::GaussianBayesNet *self, const gtsam::VectorValues &x) { return self->evaluate(x); }, py::arg("x"))
      ...
      .def("optimize", [](gtsam::GaussianBayesNet *self, const gtsam::VectorValues &given) { return self->optimize(given); }, py::arg("given"))
      .def("optimizeGradientSearch", [](gtsam::GaussianBayesNet *self) { return self->optimizeGradientSearch(); })
      .def("sample", [](gtsam::GaussianBayesNet *self, const gtsam::VectorValues &given) { return self->sample(given); }, py::arg("given"))

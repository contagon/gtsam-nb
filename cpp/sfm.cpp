...
void sfm(py::module_ &m_) {
  ...
  py::class_<gtsam::SfmTrack, gtsam::SfmTrack2d, boost::shared_ptr<gtsam::SfmTrack>>(m_, "SfmTrack")
      ...
      .def(py::pickle([](const gtsam::SfmTrack &a) { /* __getstate__: Returns a string that encodes the state of the object */ return py::make_tuple(gtsam::serialize(a)); }, [](py::tuple t) { /* __setstate__ */ gtsam::SfmTrack obj; gtsam::deserialize(t[0].cast<std::string>(), obj); return obj; }))
  ...
  py::class_<gtsam::SfmData, boost::shared_ptr<gtsam::SfmData>>(m_, "SfmData")
      ...
      .def(py::pickle([](const gtsam::SfmData &a) { /* __getstate__: Returns a string that encodes the state of the object */ return py::make_tuple(gtsam::serialize(a)); }, [](py::tuple t) { /* __setstate__ */ gtsam::SfmData obj; gtsam::deserialize(t[0].cast<std::string>(), obj); return obj; }))

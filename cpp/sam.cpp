...
void sam(py::module_ &m_) {
  ...
  py::class_<gtsam::RangeFactor<gtsam::Point2, gtsam::Point2>, gtsam::NoiseModelFactor, boost::shared_ptr<gtsam::RangeFactor<gtsam::Point2, gtsam::Point2>>>(m_, "RangeFactor2")
      ...
      .def(py::pickle([](const gtsam::RangeFactor<gtsam::Point2, gtsam::Point2> &a) { /* __getstate__: Returns a string that encodes the state of the object */ return py::make_tuple(gtsam::serialize(a)); }, [](py::tuple t) { /* __setstate__ */ gtsam::RangeFactor<gtsam::Point2, gtsam::Point2> obj; gtsam::deserialize(t[0].cast<std::string>(), obj); return obj; }))
  ...
  py::class_<gtsam::RangeFactor<gtsam::Point3, gtsam::Point3>, gtsam::NoiseModelFactor, boost::shared_ptr<gtsam::RangeFactor<gtsam::Point3, gtsam::Point3>>>(m_, "RangeFactor3")
      ...
      .def(py::pickle([](const gtsam::RangeFactor<gtsam::Point3, gtsam::Point3> &a) { /* __getstate__: Returns a string that encodes the state of the object */ return py::make_tuple(gtsam::serialize(a)); }, [](py::tuple t) { /* __setstate__ */ gtsam::RangeFactor<gtsam::Point3, gtsam::Point3> obj; gtsam::deserialize(t[0].cast<std::string>(), obj); return obj; }))
  ...
  py::class_<gtsam::RangeFactor<gtsam::Pose2, gtsam::Point2>, gtsam::NoiseModelFactor, boost::shared_ptr<gtsam::RangeFactor<gtsam::Pose2, gtsam::Point2>>>(m_, "RangeFactor2D")
      ...
      .def(py::pickle([](const gtsam::RangeFactor<gtsam::Pose2, gtsam::Point2> &a) { /* __getstate__: Returns a string that encodes the state of the object */ return py::make_tuple(gtsam::serialize(a)); }, [](py::tuple t) { /* __setstate__ */ gtsam::RangeFactor<gtsam::Pose2, gtsam::Point2> obj; gtsam::deserialize(t[0].cast<std::string>(), obj); return obj; }))
  ...
  py::class_<gtsam::RangeFactor<gtsam::Pose2, gtsam::Pose2>, gtsam::NoiseModelFactor, boost::shared_ptr<gtsam::RangeFactor<gtsam::Pose2, gtsam::Pose2>>>(m_, "RangeFactorPose2")
      ...
      .def(py::pickle([](const gtsam::RangeFactor<gtsam::Pose2, gtsam::Pose2> &a) { /* __getstate__: Returns a string that encodes the state of the object */ return py::make_tuple(gtsam::serialize(a)); }, [](py::tuple t) { /* __setstate__ */ gtsam::RangeFactor<gtsam::Pose2, gtsam::Pose2> obj; gtsam::deserialize(t[0].cast<std::string>(), obj); return obj; }))
  ...
  py::class_<gtsam::RangeFactor<gtsam::Pose3, gtsam::Point3>, gtsam::NoiseModelFactor, boost::shared_ptr<gtsam::RangeFactor<gtsam::Pose3, gtsam::Point3>>>(m_, "RangeFactor3D")
      ...
      .def(py::pickle([](const gtsam::RangeFactor<gtsam::Pose3, gtsam::Point3> &a) { /* __getstate__: Returns a string that encodes the state of the object */ return py::make_tuple(gtsam::serialize(a)); }, [](py::tuple t) { /* __setstate__ */ gtsam::RangeFactor<gtsam::Pose3, gtsam::Point3> obj; gtsam::deserialize(t[0].cast<std::string>(), obj); return obj; }))
  ...
  py::class_<gtsam::RangeFactor<gtsam::Pose3, gtsam::Pose3>, gtsam::NoiseModelFactor, boost::shared_ptr<gtsam::RangeFactor<gtsam::Pose3, gtsam::Pose3>>>(m_, "RangeFactorPose3")
      ...
      .def(py::pickle([](const gtsam::RangeFactor<gtsam::Pose3, gtsam::Pose3> &a) { /* __getstate__: Returns a string that encodes the state of the object */ return py::make_tuple(gtsam::serialize(a)); }, [](py::tuple t) { /* __setstate__ */ gtsam::RangeFactor<gtsam::Pose3, gtsam::Pose3> obj; gtsam::deserialize(t[0].cast<std::string>(), obj); return obj; }))
  ...
  py::class_<gtsam::RangeFactor<gtsam::PinholeCamera<gtsam::Cal3_S2>, gtsam::Point3>, gtsam::NoiseModelFactor, boost::shared_ptr<gtsam::RangeFactor<gtsam::PinholeCamera<gtsam::Cal3_S2>, gtsam::Point3>>>(m_, "RangeFactorSimpleCameraPoint")
      ...
      .def(py::pickle([](const gtsam::RangeFactor<gtsam::PinholeCamera<gtsam::Cal3_S2>, gtsam::Point3> &a) { /* __getstate__: Returns a string that encodes the state of the object */ return py::make_tuple(gtsam::serialize(a)); }, [](py::tuple t) { /* __setstate__ */ gtsam::RangeFactor<gtsam::PinholeCamera<gtsam::Cal3_S2>, gtsam::Point3> obj; gtsam::deserialize(t[0].cast<std::string>(), obj); return obj; }))
  ...
  py::class_<gtsam::RangeFactor<gtsam::PinholeCamera<gtsam::Cal3_S2>, gtsam::PinholeCamera<gtsam::Cal3_S2>>, gtsam::NoiseModelFactor, boost::shared_ptr<gtsam::RangeFactor<gtsam::PinholeCamera<gtsam::Cal3_S2>, gtsam::PinholeCamera<gtsam::Cal3_S2>>>>(m_, "RangeFactorSimpleCamera")
      ...
      .def(py::pickle([](const gtsam::RangeFactor<gtsam::PinholeCamera<gtsam::Cal3_S2>, gtsam::PinholeCamera<gtsam::Cal3_S2>> &a) { /* __getstate__: Returns a string that encodes the state of the object */ return py::make_tuple(gtsam::serialize(a)); }, [](py::tuple t) { /* __setstate__ */ gtsam::RangeFactor<gtsam::PinholeCamera<gtsam::Cal3_S2>, gtsam::PinholeCamera<gtsam::Cal3_S2>> obj; gtsam::deserialize(t[0].cast<std::string>(), obj); return obj; }))
  ...
  py::class_<gtsam::RangeFactorWithTransform<gtsam::Pose2, gtsam::Point2>, gtsam::NoiseModelFactor, boost::shared_ptr<gtsam::RangeFactorWithTransform<gtsam::Pose2, gtsam::Point2>>>(m_, "RangeFactorWithTransform2D")
      ...
      .def(py::pickle([](const gtsam::RangeFactorWithTransform<gtsam::Pose2, gtsam::Point2> &a) { /* __getstate__: Returns a string that encodes the state of the object */ return py::make_tuple(gtsam::serialize(a)); }, [](py::tuple t) { /* __setstate__ */ gtsam::RangeFactorWithTransform<gtsam::Pose2, gtsam::Point2> obj; gtsam::deserialize(t[0].cast<std::string>(), obj); return obj; }))
  ...
  py::class_<gtsam::RangeFactorWithTransform<gtsam::Pose3, gtsam::Point3>, gtsam::NoiseModelFactor, boost::shared_ptr<gtsam::RangeFactorWithTransform<gtsam::Pose3, gtsam::Point3>>>(m_, "RangeFactorWithTransform3D")
      ...
      .def(py::pickle([](const gtsam::RangeFactorWithTransform<gtsam::Pose3, gtsam::Point3> &a) { /* __getstate__: Returns a string that encodes the state of the object */ return py::make_tuple(gtsam::serialize(a)); }, [](py::tuple t) { /* __setstate__ */ gtsam::RangeFactorWithTransform<gtsam::Pose3, gtsam::Point3> obj; gtsam::deserialize(t[0].cast<std::string>(), obj); return obj; }))
  ...
  py::class_<gtsam::RangeFactorWithTransform<gtsam::Pose2, gtsam::Pose2>, gtsam::NoiseModelFactor, boost::shared_ptr<gtsam::RangeFactorWithTransform<gtsam::Pose2, gtsam::Pose2>>>(m_, "RangeFactorWithTransformPose2")
      ...
      .def(py::pickle([](const gtsam::RangeFactorWithTransform<gtsam::Pose2, gtsam::Pose2> &a) { /* __getstate__: Returns a string that encodes the state of the object */ return py::make_tuple(gtsam::serialize(a)); }, [](py::tuple t) { /* __setstate__ */ gtsam::RangeFactorWithTransform<gtsam::Pose2, gtsam::Pose2> obj; gtsam::deserialize(t[0].cast<std::string>(), obj); return obj; }))
  ...
  py::class_<gtsam::RangeFactorWithTransform<gtsam::Pose3, gtsam::Pose3>, gtsam::NoiseModelFactor, boost::shared_ptr<gtsam::RangeFactorWithTransform<gtsam::Pose3, gtsam::Pose3>>>(m_, "RangeFactorWithTransformPose3")
      ...
      .def(py::pickle([](const gtsam::RangeFactorWithTransform<gtsam::Pose3, gtsam::Pose3> &a) { /* __getstate__: Returns a string that encodes the state of the object */ return py::make_tuple(gtsam::serialize(a)); }, [](py::tuple t) { /* __setstate__ */ gtsam::RangeFactorWithTransform<gtsam::Pose3, gtsam::Pose3> obj; gtsam::deserialize(t[0].cast<std::string>(), obj); return obj; }))
  ...
  py::class_<gtsam::BearingRangeFactor<gtsam::Pose2, gtsam::Point2, gtsam::Rot2, double>, gtsam::NoiseModelFactor, boost::shared_ptr<gtsam::BearingRangeFactor<gtsam::Pose2, gtsam::Point2, gtsam::Rot2, double>>>(m_, "BearingRangeFactor2D")
      ...
      .def(py::pickle([](const gtsam::BearingRangeFactor<gtsam::Pose2, gtsam::Point2, gtsam::Rot2, double> &a) { /* __getstate__: Returns a string that encodes the state of the object */ return py::make_tuple(gtsam::serialize(a)); }, [](py::tuple t) { /* __setstate__ */ gtsam::BearingRangeFactor<gtsam::Pose2, gtsam::Point2, gtsam::Rot2, double> obj; gtsam::deserialize(t[0].cast<std::string>(), obj); return obj; }));
  ...
  py::class_<gtsam::BearingRangeFactor<gtsam::Pose2, gtsam::Pose2, gtsam::Rot2, double>, gtsam::NoiseModelFactor, boost::shared_ptr<gtsam::BearingRangeFactor<gtsam::Pose2, gtsam::Pose2, gtsam::Rot2, double>>>(m_, "BearingRangeFactorPose2")
      ...
      .def(py::pickle([](const gtsam::BearingRangeFactor<gtsam::Pose2, gtsam::Pose2, gtsam::Rot2, double> &a) { /* __getstate__: Returns a string that encodes the state of the object */ return py::make_tuple(gtsam::serialize(a)); }, [](py::tuple t) { /* __setstate__ */ gtsam::BearingRangeFactor<gtsam::Pose2, gtsam::Pose2, gtsam::Rot2, double> obj; gtsam::deserialize(t[0].cast<std::string>(), obj); return obj; }));
  ...
  py::class_<gtsam::BearingRangeFactor<gtsam::Pose3, gtsam::Point3, gtsam::Unit3, double>, gtsam::NoiseModelFactor, boost::shared_ptr<gtsam::BearingRangeFactor<gtsam::Pose3, gtsam::Point3, gtsam::Unit3, double>>>(m_, "BearingRangeFactor3D")
      ...
      .def(py::pickle([](const gtsam::BearingRangeFactor<gtsam::Pose3, gtsam::Point3, gtsam::Unit3, double> &a) { /* __getstate__: Returns a string that encodes the state of the object */ return py::make_tuple(gtsam::serialize(a)); }, [](py::tuple t) { /* __setstate__ */ gtsam::BearingRangeFactor<gtsam::Pose3, gtsam::Point3, gtsam::Unit3, double> obj; gtsam::deserialize(t[0].cast<std::string>(), obj); return obj; }));
  ...
  py::class_<gtsam::BearingRangeFactor<gtsam::Pose3, gtsam::Pose3, gtsam::Unit3, double>, gtsam::NoiseModelFactor, boost::shared_ptr<gtsam::BearingRangeFactor<gtsam::Pose3, gtsam::Pose3, gtsam::Unit3, double>>>(m_, "BearingRangeFactorPose3")
      ...
      .def(py::pickle([](const gtsam::BearingRangeFactor<gtsam::Pose3, gtsam::Pose3, gtsam::Unit3, double> &a) { /* __getstate__: Returns a string that encodes the state of the object */ return py::make_tuple(gtsam::serialize(a)); }, [](py::tuple t) { /* __setstate__ */ gtsam::BearingRangeFactor<gtsam::Pose3, gtsam::Pose3, gtsam::Unit3, double> obj; gtsam::deserialize(t[0].cast<std::string>(), obj); return obj; }));

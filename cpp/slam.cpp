...
void slam(nb::module_ &m_) {
  ...
  nb::class_<gtsam::BetweenFactor<double>, gtsam::NoiseModelFactor>(m_, "BetweenFactorDouble")
  ...
  nb::class_<gtsam::BetweenFactor<gtsam::Vector>, gtsam::NoiseModelFactor>(m_, "BetweenFactorVector")
  ...
  nb::class_<gtsam::BetweenFactor<gtsam::Point2>, gtsam::NoiseModelFactor>(m_, "BetweenFactorPoint2")
  ...
  nb::class_<gtsam::BetweenFactor<gtsam::Point3>, gtsam::NoiseModelFactor>(m_, "BetweenFactorPoint3")
  ...
  nb::class_<gtsam::BetweenFactor<gtsam::Rot2>, gtsam::NoiseModelFactor>(m_, "BetweenFactorRot2")
  ...
  nb::class_<gtsam::BetweenFactor<gtsam::SO3>, gtsam::NoiseModelFactor>(m_, "BetweenFactorSO3")
  ...
  nb::class_<gtsam::BetweenFactor<gtsam::SO4>, gtsam::NoiseModelFactor>(m_, "BetweenFactorSO4")
  ...
  nb::class_<gtsam::BetweenFactor<gtsam::Rot3>, gtsam::NoiseModelFactor>(m_, "BetweenFactorRot3")
  ...
  nb::class_<gtsam::BetweenFactor<gtsam::Pose2>, gtsam::NoiseModelFactor>(m_, "BetweenFactorPose2")
  ...
  nb::class_<gtsam::BetweenFactor<gtsam::Pose3>, gtsam::NoiseModelFactor>(m_, "BetweenFactorPose3")
  ...
  nb::class_<gtsam::BetweenFactor<gtsam::imuBias::ConstantBias>, gtsam::NoiseModelFactor>(m_, "BetweenFactorConstantBias")
  ...
  nb::class_<gtsam::GeneralSFMFactor2<gtsam::Cal3_S2>, gtsam::NoiseModelFactor>(m_, "GeneralSFMFactor2Cal3_S2")
  ...
  nb::class_<gtsam::GeneralSFMFactor2<gtsam::Cal3DS2>, gtsam::NoiseModelFactor>(m_, "GeneralSFMFactor2Cal3DS2")
      .def(nb::init<const gtsam::Point2 &, const boost::shared_ptr<gtsam::noiseModel::Base>, size_t, size_t, size_t>(), nb::arg("measured"), nb::arg("model"), nb::arg("poseKey"), nb::arg("landmarkKey"), nb::arg("calibKey"))
  ...
  nb::class_<gtsam::GeneralSFMFactor2<gtsam::Cal3Bundler>, gtsam::NoiseModelFactor>(m_, "GeneralSFMFactor2Cal3Bundler")
      .def(nb::init<const gtsam::Point2 &, const boost::shared_ptr<gtsam::noiseModel::Base>, size_t, size_t, size_t>(), nb::arg("measured"), nb::arg("model"), nb::arg("poseKey"), nb::arg("landmarkKey"), nb::arg("calibKey"))
  ...
  nb::class_<gtsam::GeneralSFMFactor2<gtsam::Cal3Fisheye>, gtsam::NoiseModelFactor>(m_, "GeneralSFMFactor2Cal3Fisheye")
      .def(nb::init<const gtsam::Point2 &, const boost::shared_ptr<gtsam::noiseModel::Base>, size_t, size_t, size_t>(), nb::arg("measured"), nb::arg("model"), nb::arg("poseKey"), nb::arg("landmarkKey"), nb::arg("calibKey"))
  ...
  nb::class_<gtsam::GeneralSFMFactor2<gtsam::Cal3Unified>, gtsam::NoiseModelFactor>(m_, "GeneralSFMFactor2Cal3Unified")
      .def(nb::init<const gtsam::Point2 &, const boost::shared_ptr<gtsam::noiseModel::Base>, size_t, size_t, size_t>(), nb::arg("measured"), nb::arg("model"), nb::arg("poseKey"), nb::arg("landmarkKey"), nb::arg("calibKey"))
  ...
  nb::class_<gtsam::KarcherMeanFactor<gtsam::Point2>, gtsam::NonlinearFactor>(m_, "KarcherMeanFactorPoint2")
      .def(nb::init<const gtsam::KeyVector &>(), nb::arg("keys"));

  nb::class_<gtsam::KarcherMeanFactor<gtsam::Rot2>, gtsam::NonlinearFactor>(m_, "KarcherMeanFactorRot2")
      .def(nb::init<const gtsam::KeyVector &>(), nb::arg("keys"));

  nb::class_<gtsam::KarcherMeanFactor<gtsam::Pose2>, gtsam::NonlinearFactor>(m_, "KarcherMeanFactorPose2")
      .def(nb::init<const gtsam::KeyVector &>(), nb::arg("keys"));

  nb::class_<gtsam::KarcherMeanFactor<gtsam::Point3>, gtsam::NonlinearFactor>(m_, "KarcherMeanFactorPoint3")
      .def(nb::init<const gtsam::KeyVector &>(), nb::arg("keys"));

  nb::class_<gtsam::KarcherMeanFactor<gtsam::SO3>, gtsam::NonlinearFactor>(m_, "KarcherMeanFactorSO3")
      .def(nb::init<const gtsam::KeyVector &>(), nb::arg("keys"));

  nb::class_<gtsam::KarcherMeanFactor<gtsam::SO4>, gtsam::NonlinearFactor>(m_, "KarcherMeanFactorSO4")
      .def(nb::init<const gtsam::KeyVector &>(), nb::arg("keys"));

  nb::class_<gtsam::KarcherMeanFactor<gtsam::Rot3>, gtsam::NonlinearFactor>(m_, "KarcherMeanFactorRot3")
      .def(nb::init<const gtsam::KeyVector &>(), nb::arg("keys"));

  nb::class_<gtsam::KarcherMeanFactor<gtsam::Pose3>, gtsam::NonlinearFactor>(m_, "KarcherMeanFactorPose3")
      .def(nb::init<const gtsam::KeyVector &>(), nb::arg("keys"));

  nb::class_<gtsam::FrobeniusFactor<gtsam::SO3>, gtsam::NoiseModelFactor>(m_, "FrobeniusFactorSO3")
  ...
  nb::class_<gtsam::FrobeniusFactor<gtsam::SO4>, gtsam::NoiseModelFactor>(m_, "FrobeniusFactorSO4")
      .def(nb::init<size_t, size_t>(), nb::arg("key1"), nb::arg("key2"))
      .def(nb::init<size_t, size_t, boost::shared_ptr<gtsam::noiseModel::Base>>(), nb::arg("key1"), nb::arg("key2"), nb::arg("model"))
  ...
  nb::class_<gtsam::FrobeniusBetweenFactor<gtsam::SO3>, gtsam::NoiseModelFactor>(m_, "FrobeniusBetweenFactorSO3")
  ...
  nb::class_<gtsam::FrobeniusBetweenFactor<gtsam::SO4>, gtsam::NoiseModelFactor>(m_, "FrobeniusBetweenFactorSO4")
  ...
  nb::class_<gtsam::GenericProjectionFactor<gtsam::Pose3, gtsam::Point3, gtsam::Cal3_S2>, gtsam::NoiseModelFactor>(m_, "GenericProjectionFactorCal3_S2")
  ...
  nb::class_<gtsam::GenericProjectionFactor<gtsam::Pose3, gtsam::Point3, gtsam::Cal3DS2>, gtsam::NoiseModelFactor>(m_, "GenericProjectionFactorCal3DS2")
  ...
  nb::class_<gtsam::GenericProjectionFactor<gtsam::Pose3, gtsam::Point3, gtsam::Cal3Fisheye>, gtsam::NoiseModelFactor>(m_, "GenericProjectionFactorCal3Fisheye")
  ...
  nb::class_<gtsam::GenericProjectionFactor<gtsam::Pose3, gtsam::Point3, gtsam::Cal3Unified>, gtsam::NoiseModelFactor>(m_, "GenericProjectionFactorCal3Unified")
  ...
  nb::class_<gtsam::GeneralSFMFactor<gtsam::PinholeCamera<gtsam::Cal3_S2>, gtsam::Point3>, gtsam::NoiseModelFactor>(m_, "GeneralSFMFactorCal3_S2")
  ...
  nb::class_<gtsam::GeneralSFMFactor<gtsam::PinholeCamera<gtsam::Cal3DS2>, gtsam::Point3>, gtsam::NoiseModelFactor>(m_, "GeneralSFMFactorCal3DS2")
      .def(nb::init<const gtsam::Point2 &, const boost::shared_ptr<gtsam::noiseModel::Base>, size_t, size_t>(), nb::arg("measured"), nb::arg("model"), nb::arg("cameraKey"), nb::arg("landmarkKey"))
      .def("measured", [](gtsam::GeneralSFMFactor<gtsam::PinholeCamera<gtsam::Cal3DS2>, gtsam::Point3> *self) { return self->measured(); });

  nb::class_<gtsam::GeneralSFMFactor<gtsam::PinholeCamera<gtsam::Cal3Bundler>, gtsam::Point3>, gtsam::NoiseModelFactor>(m_, "GeneralSFMFactorCal3Bundler")
      .def(nb::init<const gtsam::Point2 &, const boost::shared_ptr<gtsam::noiseModel::Base>, size_t, size_t>(), nb::arg("measured"), nb::arg("model"), nb::arg("cameraKey"), nb::arg("landmarkKey"))
      .def("measured", [](gtsam::GeneralSFMFactor<gtsam::PinholeCamera<gtsam::Cal3Bundler>, gtsam::Point3> *self) { return self->measured(); });

  nb::class_<gtsam::GeneralSFMFactor<gtsam::PinholeCamera<gtsam::Cal3Fisheye>, gtsam::Point3>, gtsam::NoiseModelFactor>(m_, "GeneralSFMFactorCal3Fisheye")
      .def(nb::init<const gtsam::Point2 &, const boost::shared_ptr<gtsam::noiseModel::Base>, size_t, size_t>(), nb::arg("measured"), nb::arg("model"), nb::arg("cameraKey"), nb::arg("landmarkKey"))
      .def("measured", [](gtsam::GeneralSFMFactor<gtsam::PinholeCamera<gtsam::Cal3Fisheye>, gtsam::Point3> *self) { return self->measured(); });

  nb::class_<gtsam::GeneralSFMFactor<gtsam::PinholeCamera<gtsam::Cal3Unified>, gtsam::Point3>, gtsam::NoiseModelFactor>(m_, "GeneralSFMFactorCal3Unified")
      .def(nb::init<const gtsam::Point2 &, const boost::shared_ptr<gtsam::noiseModel::Base>, size_t, size_t>(), nb::arg("measured"), nb::arg("model"), nb::arg("cameraKey"), nb::arg("landmarkKey"))
      .def("measured", [](gtsam::GeneralSFMFactor<gtsam::PinholeCamera<gtsam::Cal3Unified>, gtsam::Point3> *self) { return self->measured(); });

  nb::class_<gtsam::GeneralSFMFactor<gtsam::PinholePose<gtsam::Cal3_S2>, gtsam::Point3>, gtsam::NoiseModelFactor>(m_, "GeneralSFMFactorPoseCal3_S2")
      .def(nb::init<const gtsam::Point2 &, const boost::shared_ptr<gtsam::noiseModel::Base>, size_t, size_t>(), nb::arg("measured"), nb::arg("model"), nb::arg("cameraKey"), nb::arg("landmarkKey"))
      .def("measured", [](gtsam::GeneralSFMFactor<gtsam::PinholePose<gtsam::Cal3_S2>, gtsam::Point3> *self) { return self->measured(); });

  nb::class_<gtsam::GeneralSFMFactor<gtsam::PinholePose<gtsam::Cal3DS2>, gtsam::Point3>, gtsam::NoiseModelFactor>(m_, "GeneralSFMFactorPoseCal3DS2")
      .def(nb::init<const gtsam::Point2 &, const boost::shared_ptr<gtsam::noiseModel::Base>, size_t, size_t>(), nb::arg("measured"), nb::arg("model"), nb::arg("cameraKey"), nb::arg("landmarkKey"))
      .def("measured", [](gtsam::GeneralSFMFactor<gtsam::PinholePose<gtsam::Cal3DS2>, gtsam::Point3> *self) { return self->measured(); });

  nb::class_<gtsam::GeneralSFMFactor<gtsam::PinholePose<gtsam::Cal3Bundler>, gtsam::Point3>, gtsam::NoiseModelFactor>(m_, "GeneralSFMFactorPoseCal3Bundler")
      .def(nb::init<const gtsam::Point2 &, const boost::shared_ptr<gtsam::noiseModel::Base>, size_t, size_t>(), nb::arg("measured"), nb::arg("model"), nb::arg("cameraKey"), nb::arg("landmarkKey"))
      .def("measured", [](gtsam::GeneralSFMFactor<gtsam::PinholePose<gtsam::Cal3Bundler>, gtsam::Point3> *self) { return self->measured(); });

  nb::class_<gtsam::GeneralSFMFactor<gtsam::PinholePose<gtsam::Cal3Fisheye>, gtsam::Point3>, gtsam::NoiseModelFactor>(m_, "GeneralSFMFactorPoseCal3Fisheye")
      .def(nb::init<const gtsam::Point2 &, const boost::shared_ptr<gtsam::noiseModel::Base>, size_t, size_t>(), nb::arg("measured"), nb::arg("model"), nb::arg("cameraKey"), nb::arg("landmarkKey"))
      .def("measured", [](gtsam::GeneralSFMFactor<gtsam::PinholePose<gtsam::Cal3Fisheye>, gtsam::Point3> *self) { return self->measured(); });

  nb::class_<gtsam::GeneralSFMFactor<gtsam::PinholePose<gtsam::Cal3Unified>, gtsam::Point3>, gtsam::NoiseModelFactor>(m_, "GeneralSFMFactorPoseCal3Unified")
      .def(nb::init<const gtsam::Point2 &, const boost::shared_ptr<gtsam::noiseModel::Base>, size_t, size_t>(), nb::arg("measured"), nb::arg("model"), nb::arg("cameraKey"), nb::arg("landmarkKey"))
      .def("measured", [](gtsam::GeneralSFMFactor<gtsam::PinholePose<gtsam::Cal3Unified>, gtsam::Point3> *self) { return self->measured(); });

  nb::class_<gtsam::SmartProjectionPoseFactor<gtsam::Cal3_S2>, gtsam::NonlinearFactor>(m_, "SmartProjectionPose3Factor")
  ...
  nb::class_<gtsam::GenericStereoFactor<gtsam::Pose3, gtsam::Point3>, gtsam::NoiseModelFactor>(m_, "GenericStereoFactor3D")
  ...
  nb::class_<gtsam::PoseTranslationPrior<gtsam::Pose2>, gtsam::NoiseModelFactor>(m_, "PoseTranslationPrior2D")
  ...
  nb::class_<gtsam::PoseTranslationPrior<gtsam::Pose3>, gtsam::NoiseModelFactor>(m_, "PoseTranslationPrior3D")
  ...
  nb::class_<gtsam::PoseRotationPrior<gtsam::Pose2>, gtsam::NoiseModelFactor>(m_, "PoseRotationPrior2D")
      .def(nb::init<size_t, const gtsam::Pose2 &, const boost::shared_ptr<gtsam::noiseModel::Base>>(), nb::arg("key"), nb::arg("pose_z"), nb::arg("noiseModel"))
      .def("measured", [](gtsam::PoseRotationPrior<gtsam::Pose2> *self) { return self->measured(); });

  nb::class_<gtsam::PoseRotationPrior<gtsam::Pose3>, gtsam::NoiseModelFactor>(m_, "PoseRotationPrior3D")
      .def(nb::init<size_t, const gtsam::Pose3 &, const boost::shared_ptr<gtsam::noiseModel::Base>>(), nb::arg("key"), nb::arg("pose_z"), nb::arg("noiseModel"))
